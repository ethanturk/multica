...
func runtimeConfigPath(workDir, provider string) string {
	...
	case "codex", "copilot", "opencode", "codearts", "deveco", "openclaw", "hermes", "pi", "cursor", "kimi", "reasonix", "dsh", "kiro", "antigravity", "dim", "dirge", "qoder", "qoderclicn", "traecli", "grok", "qwenpaw", "mcode", "zeroclaw":
