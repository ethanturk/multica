...
- **AI coding tools** — one of seventeen (or several in parallel): [Antigravity](/providers#antigravity), [Claude Code](/providers#claude-code), [CodeBuddy](/providers#codebuddy), [Codex](/providers#codex), [Copilot](/providers#copilot), [Cursor](/providers#cursor), [DevEco Code](/providers#deveco-code), [Dirge](/providers#dirge), [Grok](/providers#grok), [Hermes](/providers#hermes), [Kimi](/providers#kimi), [Kiro CLI](/providers#kiro-cli), [OpenCode](/providers#opencode), [OpenClaw](/providers#openclaw), [Pi](/providers#pi), [Qoder](/providers#qoder), and [Trae CLI](/providers#trae). Once the daemon picks up a task, it uses one of these tools to do the work.
