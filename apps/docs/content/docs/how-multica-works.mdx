...
- **AI coding tools** — one of the fifteen (or several in parallel): [Antigravity](/providers#antigravity), [Claude Code](/providers#claude-code), [CodeBuddy](/providers#codebuddy), [Codex](/providers#codex), [Cursor](/providers#cursor), [Dirge](/providers#dirge), [Copilot](/providers#copilot), [Hermes](/providers#hermes), [Kimi](/providers#kimi), [Kiro CLI](/providers#kiro-cli), [OpenCode](/providers#opencode), [OpenClaw](/providers#openclaw), [Pi](/providers#pi), [Qoder](/providers#qoder), [Trae CLI](/providers#trae). Once the daemon has picked up a task, it uses these tools to actually do the work., [Trae CLI](/providers#trae), [DevEco Code](/providers#deveco-code). Once the daemon has picked up a task, - **AI coding tools** — one of the sixteen (or several in parallel): [Antigravity](/providers#antigravity), [DevEco Code](/providers#deveco-code), [Grok](/providers#grok). Once the daemon has picked up a task
