...
- ✅ **Real support** — Antigravity, Claude Code, Codex, Copilot, Cursor, Dirge, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, Pi
- ❌ **No support** — Gemini
...
- [Providers Matrix](/providers) — capability differences across the 15 AI coding tools (including the exact session-resumption status)
